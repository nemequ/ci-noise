...
test_simde_vcvt_u16_f16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  struct {
    ...
    { { SIMDE_FLOAT16_VALUE(   692.50), SIMDE_FLOAT16_VALUE(   210.50), SIMDE_FLOAT16_VALUE(  -740.50), SIMDE_FLOAT16_VALUE(  -447.00) },
      { UINT16_C(  692), UINT16_C(  210), UINT16_C(    0), UINT16_C(    0) } },
    { { SIMDE_FLOAT16_VALUE(   161.25), SIMDE_FLOAT16_VALUE(   443.75), SIMDE_FLOAT16_VALUE(   562.50), SIMDE_FLOAT16_VALUE(  -710.50) },
      { UINT16_C(  161), UINT16_C(  443), UINT16_C(  562), UINT16_C(    0) } },
    { { SIMDE_FLOAT16_VALUE(  -624.00), SIMDE_FLOAT16_VALUE(   893.50), SIMDE_FLOAT16_VALUE(    46.34), SIMDE_FLOAT16_VALUE(  -567.50) },
      { UINT16_C(    0), UINT16_C(  893), UINT16_C(   46), UINT16_C(    0) } },
    { { SIMDE_FLOAT16_VALUE(   824.50), SIMDE_FLOAT16_VALUE(  -510.00), SIMDE_FLOAT16_VALUE(   -33.38), SIMDE_FLOAT16_VALUE(   895.00) },
      { UINT16_C(  824), UINT16_C(    0), UINT16_C(    0), UINT16_C(  895) } },
    { { SIMDE_FLOAT16_VALUE(   765.00), SIMDE_FLOAT16_VALUE(  -755.50), SIMDE_FLOAT16_VALUE(  -448.75), SIMDE_FLOAT16_VALUE(   181.75) },
      { UINT16_C(  765), UINT16_C(    0), UINT16_C(    0), UINT16_C(  181) } },
    { { SIMDE_FLOAT16_VALUE(  -751.00), SIMDE_FLOAT16_VALUE(   396.75), SIMDE_FLOAT16_VALUE(  -523.50), SIMDE_FLOAT16_VALUE(  -362.50) },
      { UINT16_C(    0), UINT16_C(  396), UINT16_C(    0), UINT16_C(    0) } }
  };
...
test_simde_vcvtq_u16_f16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  struct {
    ...
    { { SIMDE_FLOAT16_VALUE(  -161.50), SIMDE_FLOAT16_VALUE(   150.88), SIMDE_FLOAT16_VALUE(   284.00), SIMDE_FLOAT16_VALUE(     4.51),
        SIMDE_FLOAT16_VALUE(   923.50), SIMDE_FLOAT16_VALUE(   784.50), SIMDE_FLOAT16_VALUE(   129.50), SIMDE_FLOAT16_VALUE(   969.50) },
      { UINT16_C(    0), UINT16_C(  150), UINT16_C(  284), UINT16_C(    4), UINT16_C(  923), UINT16_C(  784), UINT16_C(  129), UINT16_C(  969) } },
    { { SIMDE_FLOAT16_VALUE(   735.50), SIMDE_FLOAT16_VALUE(   298.00), SIMDE_FLOAT16_VALUE(   902.00), SIMDE_FLOAT16_VALUE(   419.50),
        SIMDE_FLOAT16_VALUE(  -868.00), SIMDE_FLOAT16_VALUE(   759.50), SIMDE_FLOAT16_VALUE(   325.25), SIMDE_FLOAT16_VALUE(   100.94) },
      { UINT16_C(  735), UINT16_C(  298), UINT16_C(  902), UINT16_C(  419), UINT16_C(    0), UINT16_C(  759), UINT16_C(  325), UINT16_C(  100) } },
    { { SIMDE_FLOAT16_VALUE(  -211.50), SIMDE_FLOAT16_VALUE(   457.75), SIMDE_FLOAT16_VALUE(    69.62), SIMDE_FLOAT16_VALUE(  -587.00),
        SIMDE_FLOAT16_VALUE(  -766.00), SIMDE_FLOAT16_VALUE(   -55.22), SIMDE_FLOAT16_VALUE(    72.00), SIMDE_FLOAT16_VALUE(   146.00) },
      { UINT16_C(    0), UINT16_C(  457), UINT16_C(   69), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(   72), UINT16_C(  146) } },
    { { SIMDE_FLOAT16_VALUE(   872.50), SIMDE_FLOAT16_VALUE(   -68.00), SIMDE_FLOAT16_VALUE(   444.25), SIMDE_FLOAT16_VALUE(    25.62),
        SIMDE_FLOAT16_VALUE(     2.22), SIMDE_FLOAT16_VALUE(   751.50), SIMDE_FLOAT16_VALUE(   -45.91), SIMDE_FLOAT16_VALUE(   840.50) },
      { UINT16_C(  872), UINT16_C(    0), UINT16_C(  444), UINT16_C(   25), UINT16_C(    2), UINT16_C(  751), UINT16_C(    0), UINT16_C(  840) } },
    { { SIMDE_FLOAT16_VALUE(   -97.50), SIMDE_FLOAT16_VALUE(  -762.00), SIMDE_FLOAT16_VALUE(  -154.75), SIMDE_FLOAT16_VALUE(  -173.88),
        SIMDE_FLOAT16_VALUE(  -977.50), SIMDE_FLOAT16_VALUE(   974.50), SIMDE_FLOAT16_VALUE(  -204.38), SIMDE_FLOAT16_VALUE(   758.50) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(  974), UINT16_C(    0), UINT16_C(  758) } },
    { { SIMDE_FLOAT16_VALUE(   272.75), SIMDE_FLOAT16_VALUE(  -302.25), SIMDE_FLOAT16_VALUE(   177.88), SIMDE_FLOAT16_VALUE(   404.50),
        SIMDE_FLOAT16_VALUE(  -543.00), SIMDE_FLOAT16_VALUE(  -496.75), SIMDE_FLOAT16_VALUE(  -494.75), SIMDE_FLOAT16_VALUE(   245.50) },
      { UINT16_C(  272), UINT16_C(    0), UINT16_C(  177), UINT16_C(  404), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(  245) } }
  };
